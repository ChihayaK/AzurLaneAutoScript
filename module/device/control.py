...
from module.device.method.maatool import MaaTools


class Control(Hermit, Minitouch, Scrcpy, MaaTouch, NemuIpc, MaaTools):
    ...
    def swipe(self, p1, p2, duration=(0.1, 0.2), name='SWIPE', distance_check=True):
        ...
        elif method in ['minitouch', 'MaaTouch', 'scrcpy', 'nemu_ipc', 'MaaTools']:
