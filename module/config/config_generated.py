...
class GeneratedConfig:
    ...
    Emulator_ScreenshotMethod = 'MaaTools'  # auto, ADB, ADB_nc, uiautomator2, aScreenCap, aScreenCap_nc, DroidCast, DroidCast_raw, scrcpy, nemu_ipc, ldopengl, MaaTools
    Emulator_ControlMethod = 'MaaTools'  # ADB, uiautomator2, minitouch, Hermit, MaaTouch, MaaTools
    Emulator_ScreenshotDedithering = False
    Emulator_AdbRestart = False

    # Group `EmulatorInfo`
    EmulatorInfo_Emulator = 'auto'  # auto, NoxPlayer, NoxPlayer64, BlueStacks4, BlueStacks5, BlueStacks4HyperV, BlueStacks5HyperV, LDPlayer3, LDPlayer4, LDPlayer9, MuMuPlayer, MuMuPlayerX, MuMuPlayer12, MEmuPlayer, PlayCover
